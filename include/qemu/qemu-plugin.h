...
/**
 * typedef qemu_plugin_vcpu_interrupt_cb_t - vcpu callback
 * @vcpu_index: the current vcpu context
 * @intno: interrupt number
 * @is_hw: non-zero if interrupt generated by emulated device
 */
typedef void (*qemu_plugin_vcpu_interrupt_cb_t)(unsigned int vcpu_index,
                                                int intno, int is_hw);
...
/**
 * qemu_plugin_register_vcpu_interrupt_enter_cb() - register a vCPU enters interrupt handler callback
 * @id: plugin ID
 * @cb: callback function
 *
 * The @cb function is called every time a vCPU starts interrupt processing.
 */
void qemu_plugin_register_vcpu_interrupt_enter_cb(qemu_plugin_id_t id,
                                                  qemu_plugin_vcpu_interrupt_cb_t cb);

/**
 * qemu_plugin_register_vcpu_interrupt_leave_cb() - register a vCPU leaves interrupt handler callback
 * @id: plugin ID
 * @cb: callback function
 *
 * The @cb function is called every time a vCPU finishes interrupt processing.
 */
